...
PROTOBUF_CONSTEXPR S_PlayerNormalSpeed::S_PlayerNormalSpeed(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.objectid_)*/uint64_t{0u}
  , /*decltype(_impl_.normalspeed_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct S_PlayerNormalSpeedDefaultTypeInternal {
  PROTOBUF_CONSTEXPR S_PlayerNormalSpeedDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~S_PlayerNormalSpeedDefaultTypeInternal() {}
  union {
    S_PlayerNormalSpeed _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 S_PlayerNormalSpeedDefaultTypeInternal _S_PlayerNormalSpeed_default_instance_;
...
PROTOBUF_CONSTEXPR S_MainState::S_MainState(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.playerid_)*/uint64_t{0u}
  , /*decltype(_impl_.mainstate_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct S_MainStateDefaultTypeInternal {
  PROTOBUF_CONSTEXPR S_MainStateDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~S_MainStateDefaultTypeInternal() {}
  union {
    S_MainState _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 S_MainStateDefaultTypeInternal _S_MainState_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_RemoveItem, _impl_.objectid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_PlayerNormalSpeed, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_PlayerNormalSpeed, _impl_.objectid_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_PlayerNormalSpeed, _impl_.normalspeed_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_Skill, _impl_.playerid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MainState, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MainState, _impl_.playerid_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MainState, _impl_.mainstate_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 93, -1, -1, sizeof(::Protocol::S_RemoveItem)},
  { 100, -1, -1, sizeof(::Protocol::S_PlayerNormalSpeed)},
  { 108, -1, -1, sizeof(::Protocol::C_Skill)},
  { 115, -1, -1, sizeof(::Protocol::S_MainState)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_S_PlayerNormalSpeed_default_instance_._instance,
  &::Protocol::_C_Skill_default_instance_._instance,
  &::Protocol::_S_MainState_default_instance_._instance,
};
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "S_PlayerLeave\022\020\n\010objectid\030\001 \001(\004\"V\n\006C_Mov"
  "e\022\020\n\010objectid\030\001 \001(\004\022\021\n\tmovestate\030\002 \001(\r\022\013"
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 1020, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _impl_.movestate_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* C_Move::_InternalSerialize(
  ...
  if (this->_internal_movestate() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(2, this->_internal_movestate(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_Move)
  ...
  // uint32 movestate = 2;
  if (this->_internal_movestate() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_movestate());
  }
...
class S_PlayerNormalSpeed::_Internal {
 public:
};

S_PlayerNormalSpeed::S_PlayerNormalSpeed(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.S_PlayerNormalSpeed)
}
S_PlayerNormalSpeed::S_PlayerNormalSpeed(const S_PlayerNormalSpeed& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  S_PlayerNormalSpeed* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.objectid_){}
    , decltype(_impl_.normalspeed_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.objectid_, &from._impl_.objectid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.normalspeed_) -
    reinterpret_cast<char*>(&_impl_.objectid_)) + sizeof(_impl_.normalspeed_));
  // @@protoc_insertion_point(copy_constructor:Protocol.S_PlayerNormalSpeed)
}

inline void S_PlayerNormalSpeed::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
S_PlayerNormalSpeed::~S_PlayerNormalSpeed() {
  // @@protoc_insertion_point(destructor:Protocol.S_PlayerNormalSpeed)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void S_PlayerNormalSpeed::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void S_PlayerNormalSpeed::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void S_PlayerNormalSpeed::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.S_PlayerNormalSpeed)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;

  ::memset(&_impl_.objectid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.normalspeed_) -
      reinterpret_cast<char*>(&_impl_.objectid_)) + sizeof(_impl_.normalspeed_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* S_PlayerNormalSpeed::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 21)) {
          _impl_.normalspeed_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* S_PlayerNormalSpeed::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.S_PlayerNormalSpeed)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // float normalspeed = 2;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_normalspeed = this->_internal_normalspeed();
  uint32_t raw_normalspeed;
  memcpy(&raw_normalspeed, &tmp_normalspeed, sizeof(tmp_normalspeed));
  if (raw_normalspeed != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(2, this->_internal_normalspeed(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.S_PlayerNormalSpeed)
  return target;
}

size_t S_PlayerNormalSpeed::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_PlayerNormalSpeed)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData S_PlayerNormalSpeed::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    S_PlayerNormalSpeed::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*S_PlayerNormalSpeed::GetClassData() const { return &_class_data_; }


void S_PlayerNormalSpeed::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<S_PlayerNormalSpeed*>(&to_msg);
  auto& from = static_cast<const S_PlayerNormalSpeed&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_PlayerNormalSpeed)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_normalspeed = from._internal_normalspeed();
  uint32_t raw_normalspeed;
  memcpy(&raw_normalspeed, &tmp_normalspeed, sizeof(tmp_normalspeed));
  if (raw_normalspeed != 0) {
    _this->_internal_set_normalspeed(from._internal_normalspeed());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void S_PlayerNormalSpeed::CopyFrom(const S_PlayerNormalSpeed& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.S_PlayerNormalSpeed)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool S_PlayerNormalSpeed::IsInitialized() const {
  return true;
}

void S_PlayerNormalSpeed::InternalSwap(S_PlayerNormalSpeed* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(S_PlayerNormalSpeed, _impl_.normalspeed_)
      + sizeof(S_PlayerNormalSpeed::_impl_.normalspeed_)
      - PROTOBUF_FIELD_OFFSET(S_PlayerNormalSpeed, _impl_.objectid_)>(
          reinterpret_cast<char*>(&_impl_.objectid_),
          reinterpret_cast<char*>(&other->_impl_.objectid_));
}

::PROTOBUF_NAMESPACE_ID::Metadata S_PlayerNormalSpeed::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
class S_MainState::_Internal {
 public:
};

S_MainState::S_MainState(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.S_MainState)
}
S_MainState::S_MainState(const S_MainState& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  S_MainState* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.playerid_){}
  ...
  ::memcpy(&_impl_.playerid_, &from._impl_.playerid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.mainstate_) -
    reinterpret_cast<char*>(&_impl_.playerid_)) + sizeof(_impl_.mainstate_));
  // @@protoc_insertion_point(copy_constructor:Protocol.S_MainState)
}

inline void S_MainState::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
S_MainState::~S_MainState() {
  // @@protoc_insertion_point(destructor:Protocol.S_MainState)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void S_MainState::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void S_MainState::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void S_MainState::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.S_MainState)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;

  ::memset(&_impl_.playerid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.mainstate_) -
      reinterpret_cast<char*>(&_impl_.playerid_)) + sizeof(_impl_.mainstate_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* S_MainState::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* S_MainState::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.S_MainState)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->_internal_mainstate() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(2, this->_internal_mainstate(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.S_MainState)
  return target;
}

size_t S_MainState::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_MainState)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData S_MainState::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    S_MainState::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*S_MainState::GetClassData() const { return &_class_data_; }


void S_MainState::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<S_MainState*>(&to_msg);
  auto& from = static_cast<const S_MainState&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_MainState)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void S_MainState::CopyFrom(const S_MainState& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.S_MainState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool S_MainState::IsInitialized() const {
  return true;
}

void S_MainState::InternalSwap(S_MainState* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(S_MainState, _impl_.mainstate_)
      + sizeof(S_MainState::_impl_.mainstate_)
      - PROTOBUF_FIELD_OFFSET(S_MainState, _impl_.playerid_)>(
          reinterpret_cast<char*>(&_impl_.playerid_),
          reinterpret_cast<char*>(&other->_impl_.playerid_));
}

::PROTOBUF_NAMESPACE_ID::Metadata S_MainState::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::S_PlayerNormalSpeed*
Arena::CreateMaybeMessage< ::Protocol::S_PlayerNormalSpeed >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::S_PlayerNormalSpeed >(arena);
}
...
template<> PROTOBUF_NOINLINE ::Protocol::S_MainState*
Arena::CreateMaybeMessage< ::Protocol::S_MainState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::S_MainState >(arena);
}
